...
The analyzer checks the following cookie security attributes:
...
When no protocol is provided, the analyzer defaults to HTTPS.
```
JSON Report
```
To save the analysis results as a JSON file:
